...
pub async fn handle_setup_modules(
    ...
    if let Ok(entries) = std::fs::read_dir(&modules_dir) {
        for entry in entries.flatten() {
            ...
            if let Ok(manifest) = openclaw_sdk::ModuleManifest::from_file(&manifest_path) {
...
pub async fn handle_setup_apply(
    ...
    let templates: &[(&str, &str)] = &[
        ("AGENTS.md", include_str!("../../openclaw-defaults/agent-template/AGENTS.md")),
        ("SOUL.md", include_str!("../../openclaw-defaults/agent-template/SOUL.md")),
        ("HEARTBEAT.md", include_str!("../../openclaw-defaults/agent-template/HEARTBEAT.md")),
        ("MEMORY.md", include_str!("../../openclaw-defaults/agent-template/MEMORY.md")),
        ("PENDING_TASKS.md", include_str!("../../openclaw-defaults/agent-template/PENDING_TASKS.md")),
        ("README.md", include_str!("../../openclaw-defaults/agent-template/README.md")),
        ("FIRST_RUN.md", include_str!("../../openclaw-defaults/agent-template/FIRST_RUN.md")),
    ];
