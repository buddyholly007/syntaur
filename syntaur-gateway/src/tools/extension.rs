...
//! are defined in `syntaur-sdk` and re-exported here for backward
...
//
// These were originally defined here. Now they live in syntaur-sdk so
...
pub use syntaur_sdk::types::{Artifact, Citation, RichToolResult};
pub use syntaur_sdk::capabilities::ToolCapabilities;
